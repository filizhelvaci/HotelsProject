...
with inserted_room_type
         as ( insert into rs_room_type (name, price, person_count, size, description, created_by) values ('Deniz Manzaralı Hilton Süit',
                                                                                                          5000, 5, 131,
                                                                                                          '131 metrekare, ayrı oturma alanı, jetli küvet, panoramik manzara, ' ||
                                                                                                          ...
                                                                                                          'ütü ve ütü masası, MP3 çalar/radyo/çalar saat, yastık menüsü, çay/kahve yapma olanakları ve WiFi mevcuttur.',
                                                                                                          'flz') returning id )
insert
into rs_room_type_asset (asset_id, room_type_id)
values (14, ( select id from inserted_room_type )),
       (15, ( select id from inserted_room_type )),
       (6, ( select id from inserted_room_type )),
       (7, ( select id from inserted_room_type )),
       (8, ( select id from inserted_room_type )),
       (9, ( select id from inserted_room_type )),
       (10, ( select id from inserted_room_type )),
       (12, ( select id from inserted_room_type )),
       (13, ( select id from inserted_room_type ));


with inserted_room_type
         as ( insert into rs_room_type (name, price, person_count, size, description, created_by) values ('Bahçe Manzaralı King Yataklı Misafir Odası',
                                                                                                          2500, 2, 36,
                                                                                                          'Bahçe manzarası, balkon, küvet, duş ve ayrı tuvalet, ' ||
                                                                                                          ...
                                                                                                          'çay/kahve yapma olanakları yer almaktadır.',
                                                                                                          'flz') returning id )
insert
into rs_room_type_asset (asset_id, room_type_id)
values (6, ( select id from inserted_room_type )),
       (8, ( select id from inserted_room_type )),
       (9, ( select id from inserted_room_type )),
       (10, ( select id from inserted_room_type )),
       (11, ( select id from inserted_room_type )),
       (12, ( select id from inserted_room_type )),
       (13, ( select id from inserted_room_type )),
       (14, ( select id from inserted_room_type )),
       (15, ( select id from inserted_room_type ));


with inserted_room_type
         as ( insert into rs_room_type (name, price, person_count, size, description, created_by) values ('Deniz Manzaralı Havuz Bağlantılı King Yataklı Misafir Odası',
                                                                                                          3000, 2, 34,
                                                                                                          '34 metrekare, balkon, ' ||
                                                                                                          ...
                                                                                                          'Diğer hizmetler arasında WiFi, yastık menüsü ve çay ve kahve yapma olanakları yer almaktadır.',
                                                                                                          'flz') returning id )
insert
into rs_room_type_asset (asset_id, room_type_id)
values (6, ( select id from inserted_room_type )),
...
with inserted_room_type
         as ( insert into rs_room_type (name, price, person_count, size, description, created_by) values ('Nehir Manzaralı King Yataklı Misafir Odası',
                                                                                                          3000, 2, 36,
                                                                                                          '36 metrekare, nehir manzarası, 55 inçlik LCD TV, ' ||
...
with inserted_room_type
         as ( insert into rs_room_type (name, price, person_count, size, description, created_by) values ('Bahçe Manzaralı Aile Odası',
                                                                                                          5000, 4, 76,
                                                                                                          '76 metrekare, iki ayrı yatak odası, 55 inçlik LCD TV, Ahşap Lamine Zemin' ||
                                                                                                          ...
                                                                                                          'yastık menüsü, çay/kahve yapma olanaklarını ve WiFi erişimini kapsamaktadır.',
                                                                                                          'flz') returning id )
insert
into rs_room_type_asset (asset_id, room_type_id)
values (6, ( select id from inserted_room_type )),
...
with inserted_room_type
         as ( insert into rs_room_type (name, price, person_count, size, description, created_by) values ('Bahçe Manzaralı Aile Dubleks Süiti',
                                                                                                          5000, 5, 96,
                                                                                                          '96 metrekare, 2 katlı, 2 odası, küçük mutfak, teras, sauna, ' ||
                                                                                                          ...
                                                                                                          'terastaki şezlongların keyfini çıkarın.',
                                                                                                          'flz') returning id )
insert
into rs_room_type_asset (asset_id, room_type_id)
values (6, ( select id from inserted_room_type )),
...
with inserted_room_type
         as ( insert into rs_room_type (name, price, person_count, size, description, created_by) values ('Havuz Manzaralı Havuza Direkt Çıkışlı Deluxe Aile Evi',
                                                                                                          7500, 6, 112,
                                                                                                          '112 metrekare, havuz erişimi, özel teras, ' ||
                                                                                                          ...
                                                                                                          ' Hizmetlere 55-inç LED TV, MP3 çalar, yastık menüsü ve WiFi dahildir.',
                                                                                                          'flz') returning id )
insert
into rs_room_type_asset (asset_id, room_type_id)
values (6, ( select id from inserted_room_type )),
...
with inserted_room_type
         as ( insert into rs_room_type (name, price, person_count, size, description, created_by) values ('Havuz Manzaralı Havuz Erişimli Göl Evi Süit',
                                                                                                          10000, 10,
                                                                                                          142,
                                                                                                          '142 metrekare, havuz erişimi, özel teras, 65 inçlik LED TV, ' ||
                                                                                                          ...
                                                                                                          'seçkin bir banyo bulunmaktadır. Hizmetlere 65-inç LED TV, MP3 çalar, yastık menüsü ve WiFi dahildir.',
                                                                                                          'flz') returning id )
insert
into rs_room_type_asset (asset_id, room_type_id)
values (6, ( select id from inserted_room_type )),
