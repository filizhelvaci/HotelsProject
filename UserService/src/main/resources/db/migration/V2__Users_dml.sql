insert into employee (first_name, last_name, identity_number, email, phone_number, address,
...
insert into old_employee (first_name, last_name, identity_number, email, phone_number, address,
                          birth_date, gender, nationality, created_by)
...
insert into department (name, status, created_by)
values ('Ön Büro', 'ACTIVE', 'Admin');

insert into department (name, status, created_by)
values ('Kat Hizmetleri', 'ACTIVE', 'Admin');

insert into department (name, status, created_by)
values ('Yiyecek ve İçecek', 'ACTIVE', 'Admin');

insert into department (name, status, created_by)
values ('Muhasebe', 'ACTIVE', 'Admin');

insert into department (name, status, created_by)
values ('İnsan Kaynakları', 'ACTIVE', 'Admin');

insert into department (name, status, created_by)
values ('Güvenlik', 'ACTIVE', 'Admin');

insert into department (name, status, created_by)
values ('Teknik Servis', 'ACTIVE', 'Admin');

insert into department (name, status, created_by)
values ('Yönetim', 'ACTIVE', 'Admin');


insert into position (name, department_id, status, created_by)
values ('Genel Müdür', 8, 'ACTIVE', 'Admin');

insert into position (name, department_id, status, created_by)
values ('Müdür Yardımcısı', 8, 'ACTIVE', 'Admin');

insert into position (name, department_id, status, created_by)
values ('Satış ve Pazarlama Müdürü', 8, 'ACTIVE', 'Admin');
...
insert into position (name, department_id, status, created_by)
values ('Muhasebe Müdürü', 4, 'ACTIVE', 'Admin');

insert into position (name, department_id, status, created_by)
values ('Insan Kaynakları Müdürü', 8, 'ACTIVE', 'Admin');
...
insert into position (name, department_id, status, created_by)
values ('Muhasebeci', 4, 'ACTIVE', 'Admin');

insert into position (name, department_id, status, created_by)
values ('İnsan Kaynakları Uzmanı', 5, 'ACTIVE', 'Admin');

insert into position (name, department_id, status, created_by)
values ('Güvenlik Görevlisi', 6, 'ACTIVE', 'Admin');

insert into position (name, department_id, status, created_by)
values ('Teknik Servis Elemanı', 7, 'ACTIVE', 'Admin');

insert into position (name, department_id, status, created_by)
values ('Etkinlik Yöneticisi', 8, 'ACTIVE', 'Admin');
