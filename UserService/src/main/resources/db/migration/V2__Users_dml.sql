...
-- --------------------------------------------------------------------
insert into ru_department (name, status, created_by)
...
insert into ru_department (name, status, created_by)
values ('Satış ve Pazarlama', 'ACTIVE', 'Admin');
insert into ru_department (name, status, created_by)
...
-- -----------------------------------------------------------------------------------
insert into ru_employee_experience (salary, employee_id, position_id, supervisor_id, start_date, created_by)
